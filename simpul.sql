...
(1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-05-18 18:47:19', NULL);
...
CREATE TABLE `masukan` (
  `id` int(11) NOT NULL,
  `type` enum('Kritik','Keluhan','Saran') NOT NULL,
...
ALTER TABLE `masukan`
  ...
  ADD KEY `idx_type_category` (`type`,`category`);
